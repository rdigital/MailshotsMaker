...
public class MSM {
	...
	Exception {
		...
		try {
			...
			//stepExecutor.clickButton("findElementByXPath", ".//*[contains(text(),'Choose Postcard')]", webDriver,"MSM");
			...
			// click on done 
			//stepExecutor.clickButton("findElementByXPath", ".//*[contains(text(),'Done')]", webDriver,"MSM");
